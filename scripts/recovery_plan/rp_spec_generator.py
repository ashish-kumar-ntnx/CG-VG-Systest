  ...
  "category_vg_list":
    {
      ...
      "vg_list": [
        {
          "vg_list": [
            {"vg_name": "vg-a-1", "authentication_type": None, "target_secret": None},
            {"vg_name": "vg-a-101", "authentication_type": None, "target_secret": None}
          ]
        }
      ]
    }
        ...
        "vm_vg_attach_list": [
          {
            "vm_name": "vm-1",
            "vg_list": [
              {"vg_name": "vg-a-1", "attachment_type": "IQN", "authentication_type": None, "client_secret": None},
              {"vg_name": "vg-a-101", "attachment_type": "IQN", "authentication_type": None, "client_secret": None}
            ]
          }
        ]
      }
...
if __name__=="__main__":
  ...
  volume_group_recovery_info_list = create_vg_list(vg_type, [{"ak-test-cat": "ak-test-val"}], vg_uuid_name_map)
  print volume_group_recovery_info_list
  """
  for i in range(1, 11):
    rp_name = "rp-" + str(i)
    categories_list = [{"cat-" + str(i) : "val-" + str(i)}]
    print "\n########"
