...
def get_vg_spec(vg_name, cluster_name, cluster_uuid, ctr_name_uuid_map, disk_count=2, disk_size_range=[5, 10], vg_password="Nutanix.1234", create_vg_with_chap=False):
  #def get_vg_spec(vg_name, cluster_name, cluster_uuid, ctr_name_uuid_map, disk_count=1, disk_size_range=[15], vg_password="Nutanix.1234", create_vg_with_chap=False):
